...
<body id="<?= $override_id ?? "main" ?>">
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" href="<?= ROOT_PATH ?>">Todo App</a>
                    ...
                    <?php if ($auth): ?>                   
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="<?= ROOT_PATH ?>/statuses/new">New</a></li>
                                <li><a class="dropdown-item" href="<?= ROOT_PATH ?>/statuses">List</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="<?= ROOT_PATH ?>/todos/new">New</a></li>
                                <li><a class="dropdown-item" href="<?= ROOT_PATH ?>/todos">List</a></li>
                            </ul>
                        </li>
